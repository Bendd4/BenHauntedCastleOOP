...
public class GameOptions extends State implements Statemethods {
    ...
    private void loadImgs() {
        ...
        bgW = (int) (optionsBackgroundImg.getWidth() * Game.SCALE / 1.125);
        bgH = (int) (optionsBackgroundImg.getHeight() * Game.SCALE / 1.125);
    ...
    public void draw(Graphics g) {
        ...
        g.drawImage(optionsBackgroundImg, bgX, bgY, bgW, bgH, null, null);
